...
$(function() {
  ...
  // Simple list example
    ...
    var simpleList = document.querySelector(".row_position");
    new Sortable(simpleList, {
      ...
      onUpdate: function() {
        ...
        $('.row_position>tr').each(function() {
            selectedData.push($(this).attr("eliminarMateria"));
        });
    ...
    function updateOrder(data) {
      ...
      $.ajax({
          ...
          success:function(data){
            console.log(data);
            swalMixin("top-end","success","Actualizado correctamente")
          }
      })
  }
  

  // PARA LAS MATERIA DE LA CALIFICACIONES
